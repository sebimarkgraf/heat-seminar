\begin{abstract}
  ...
  it is possible to laod bigger datasets and speedup the computation.
  ...
  Additionally, the scaling behaviour of HeAT depending on the number of computing nodes is profiled.
\end{abstract}
